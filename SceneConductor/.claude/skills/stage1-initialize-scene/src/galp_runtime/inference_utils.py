...
def chamfer_distance(pc1, pc2):
    ...
    # knn_xy.dists: (1, N, 1)  (note: usually returned as L2^2)
    ...
    # PyTorch3D knn_points dists are usually squared L2, so take sqrt to get L2
...
def rotation_matrix_to_6d(R):
    ...
    """
    # use the first two columns (the common definition)
