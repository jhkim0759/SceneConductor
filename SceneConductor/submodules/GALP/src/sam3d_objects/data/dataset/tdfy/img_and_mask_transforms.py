...
from src.sam3d_objects.data.dataset.tdfy.img_processing import pad_to_square_centered
from src.sam3d_objects.model.backbone.dit.embedder.point_remapper import PointRemapper
from typing import Optional, Dict
...
def normalize_pointmap_ssi(pointmap: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
    ...
    """
    from src.sam3d_objects.data.dataset.tdfy.pose_target import ScaleShiftInvariant
