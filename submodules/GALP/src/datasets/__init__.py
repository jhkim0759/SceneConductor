...
# Compatibility shim for libraries that expect `datasets.IterableDataset` (e.g., accelerate).
class IterableDataset(torch.utils.data.IterableDataset):
    pass

# from .objaverse_part import ObjaversePartDataset, BatchedObjaversePartDataset
# from .front3d import Front3DDataset, BatchedFront3DDataset
# from .objaverse import ObjaverseDataset, BatchedObjaverseDataset
# from .procthor import ProcThorDataset, BatchedProcThorDataset
from .merged_dataset import MergedDataset, BatchedMergedDataset
